...
function inferMethodParams(string $classShort, string $method): ?array {
    ...
    if ($MAP === null) {
        $MAP = [
            ...
            'CPSignedData' => [
                'Sign' => ['CPSigner $signer', 'bool $detached = false'],
                'SignCades' => ['CPSigner $signer', 'int $cadesType', 'bool $detached = false'],
                'CoSign' => ['CPSigner $signer'],
                'CoSignCades' => ['CPSigner $signer', 'int $cadesType'],
                'SignHash' => ['CPSigner $signer'],
                'CoSignHash' => ['CPSigner $signer'],
                'Verify' => ['string $signedMessage', 'bool $detached = false'],
                'VerifyCades' => ['string $signedMessage', 'int $cadesType', 'bool $detached = false'],
                'VerifyHash' => ['$hash', 'string $signedMessage'],
                'EnhanceCades' => ['string $signature', 'int $cadesType'],
